...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-800">Shto Kategori të Re</h1>
        <p class="text-gray-600 mt-2">Krijo një kategori të re për shpalljet</p>
    </div>
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea name="description" rows="4" 
                    ...
                    placeholder="Shkruaj një përshkrim të shkurtër për këtë kategori...">{{ old('description') }}</textarea>
                @error('description')
                    <span class="text-red-500 text-sm mt-1 flex items-center">
                        <span class="mr-1">⚠️</span>{{ $message }}
                    </span>
